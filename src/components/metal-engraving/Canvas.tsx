...
const Canvas = ({ width, height, canvasRef, tool, color, size }: CanvasProps) => {
    const [isPainting, setIsPainting] = useState(false);
    const [mousePosition, setMousePosition] = useState<Coordinate | undefined>(undefined);
    const [newMousePosition, setNewMousePosition] = useState<Coordinate | undefined>(undefined); //TODO - use this
